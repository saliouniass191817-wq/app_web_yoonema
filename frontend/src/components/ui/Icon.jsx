...
// Teranga icon set (Lucide-style). star / heart / flame render solid.
const ICON_PATHS = {
  ...
  heart: <path d="M12 20s-7-4.5-9.2-9C1.5 8 3 5 6 5c2 0 3 1.3 3.7 2.3C10.5 6.3 11.5 5 13.5 5c3 0 4.5 3 3.2 6-2.2 4.5-9.2 9-9.2 9z" />,
...
const SOLID = new Set(['star', 'heart', 'flame']);

export function Icon({ name, size = 22, strokeWidth = 2, stroke, fill = 'none', className = '', ...props }) {
