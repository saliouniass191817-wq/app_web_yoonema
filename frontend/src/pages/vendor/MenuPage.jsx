          ...
          <Card className="mb-8">
            <CardBody>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">Image de l’article</label>
                  <input
                  ...
                  />
                  {preview && <img src={preview} alt="Aperçu" className="mt-3 h-32 w-full rounded-lg object-cover" />}
                </div>
                ...
                <div className="flex gap-2">
                  <Button type="submit" loading={submitting || uploading}>Ajouter</Button>
