        ...
        <div className="space-y-4">
          {loading ? (
            ...
            <EmptyState
              ...
              subtitle={isAvailable ? 'Vous serez notifié quand une commande arrivera.' : 'Activez votre disponibilité pour recevoir des commandes.'}
            />
          ) : (
            orders.map((order) => (
              <Card key={order.id}>
                <CardBody>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {order.status === 'delivering' && (
                      <Button size="sm" onClick={() => handleDelivered(order.id)}>✓ Marquer livrée</Button>
                    )}
                  </div>
                </CardBody>
              </Card>
